        ...
        if serializer.is_valid():
            ...
            if username and not reconnect:
                ...
                if linkedin_account_exist:
                    raise serializers.ValidationError({ "msg" : "This Linkedin Account Is Already Connected!" })
            ...
            if reconnect and linkedin_account:
                ...
                if username and password:
                    connected, msg, linkedin_account = connect_your_linkedin(
                        request, username, password, linkedin_account.proxy, linkedin_account.timezone, linkedin_account.from_hour, linkedin_account.to_hour, linkedin_account)
                else:
                    connected, msg, linkedin_account = connect_your_linkedin(
                        request, linkedin_account.username, linkedin_account.password, linkedin_account.timezone, linkedin_account.from_hour, linkedin_account.to_hour, linkedin_account.proxy, linkedin_account)
