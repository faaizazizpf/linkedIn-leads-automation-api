...
class ProspectSerializer(serializers.ModelSerializer):
    ...
    def get_statuses(self, instance):
        ...
        if instance.state:
            ...
            for campaign_sequence in CampaignSequence.objects.filter(campaign=instance.campaign_linkedin_account.campaign, order__lt=instance.state.order):

                if campaign_sequence.step == "send_message":
                    statuses.append(
                        {"status": "Msg Sent", "color": "rgb(16, 185, 129)"})
            ...
            if instance.state.step == "send_message" and instance.state_status:

                if instance.state_status == "Performing":
                    statuses.append(
                        {"status": "Sending Msg", "color": "#5048E5"})
                    ...
                    statuses.append(
                        {"status": "Sending Msg Failed", "color": "#D14343"})
                ...
                if instance.state_status == "Performing":
                    statuses.append(
                        {"status": "Liking 3 Posts", "color": "#5048E5"})
                    ...
                    statuses.append(
                        {"status": "Liking 3 Posts Failed", "color": "#D14343"})

            elif instance.state.step == "follow":
                if instance.state_status == "Performing":
                    statuses.append(
                        {"status": "Following", "color": "#5048E5"})
                    ...
                    statuses.append(
                        {"status": "Follow Failed", "color": "#D14343"})

            elif instance.state.step == "endorse_top_5_skills":
                if instance.state_status == "Performing":
                    statuses.append(
                        {"status": "Endorsing", "color": "#5048E5"})
